...
5. Rename the extracted folder from `super-security-main` to `super-security`.
6. Copy the renamed `super-security` folder into your agent's skills directory.
...
This repository is the `super-security` skill. Keep the full `super-security` folder together when installing it.
